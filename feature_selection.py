# White Shark Optimization + Golden Eagle Optimization


import numpy as np


def WSGOA(obj_func, dim, n_sharks, max_iter, lb, ub):
    ...
    for k in range(max_iter):
        ...
        for i in range(n_sharks):
            ...
            if np.random.rand() < (1 / (1 + np.exp((max_iter / 2 - k) / 5))):
                ...
                # White Shark Updated Position (Combining WSO + GEO)
                sharks[i] = sharks[i] + rc * AV + rd * CV
